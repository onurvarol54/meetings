...
@Component({
  imports: [NgClass, RouterLink, RouterLinkActive, RouterOutlet, Breadcrumb, RoleNameTrPipe],
...
export default class Layouts implements OnInit, OnDestroy {
  ...
  readonly userDecode = computed(() => this.#common.decode());
  ...
  private initializeSidebar(): void {
    ...
    const mobileSidebarToggle =
      this.#elementRef.nativeElement.querySelector('.mobile-sidebar-toggle');
